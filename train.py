...
from dataloader.sklarge_flux import DataLayer as TrainDataset  # for deep_flux
from engines.trainer_deepflux import Trainer
...
def parse_args():
    ...
    parser.add_argument("--network", default="deep_flux", type=str)
    parser.add_argument(
        "--pretrained_model", default="pretrained_model/vgg16_caffe.pth", type=str
    )
...
if __name__ == "__main__":
    ...
    dataloader = DataLoader(
        dataset, shuffle=True, generator=torch.Generator(device="cuda")
    )  # batchsize=1
